...
export const Footer: React.FC = () => {
  const { language, t, navigate, setAdModalOpen } = useApp();
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-3">
            ...
            <p className="text-slate-400 leading-relaxed">
              {language === 'ar'
                ? 'البوابة الأولى لأندية الفنون القتالية، البطولات والأكاديميات الرياضية في منطقة الشرق الأوسط وشمال إفريقيا.'
            ...
            <ul className="space-y-1.5">
              ...
              <li>
                <button
                  ...
                  className="hover:text-amber-400 transition-colors cursor-pointer flex items-center gap-1 text-amber-500"
                >
                  <Settings className="w-3.5 h-3.5" />
                  <span>{t('ads.configure')}</span>
                </button>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-slate-400">
              Morocco • UAE • Egypt • Saudi Arabia • Tunisia • Jordan • Qatar • Algeria
            </p>
            <div className="pt-2">
              <span className="px-2.5 py-1 rounded bg-slate-900 border border-slate-800 text-[10px] text-amber-400 font-bold inline-block">
                Multilingual: العربية • Français • English
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-slate-800/80 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px]">
          ...
          <p className="flex items-center gap-1 text-slate-500">
            <span>Built with type-safety & multi-language RTL support</span>
          </p>
        </div>
      </div>
    </footer>
